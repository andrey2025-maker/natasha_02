...
_ACTION_SHORT_MAP = {
    ...
    "profile:track:open": "pto",
    "profile:track:mode:numbers": "ptn",
    "profile:track:mode:comments": "ptc",
    "profile:track:more": "ptm",
    "profile:track:done": "ptd",
    "admin:tracks:txt": "att",
    "admin:tracks:scanner": "ats",
    "admin:tracks:back": "atb",
    "admin:tracks:root": "atr",
    "admin:tracks:comment:yes": "atcy",
    "admin:tracks:comment:no": "atcn",
    "questions": "q",
    "process": "prc",
    "processed": "prcd",
}
